cmd_/media/Data_Movies/NageshA/help_desk/test/drivers/new-demo-examples/day1/1-hello/hello5.mod.o := gcc -Wp,-MD,/media/Data_Movies/NageshA/help_desk/test/drivers/new-demo-examples/day1/1-hello/.hello5.mod.o.d  -nostdinc -isystem /usr/lib/gcc/i586-redhat-linux/4.4.0/include -Iinclude  -I/usr/src/linux-2.6.30/arch/x86/include -include include/linux/autoconf.h -D__KERNEL__ -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Os -m32 -msoft-float -mregparm=3 -freg-struct-return -mpreferred-stack-boundary=2 -march=i686 -mtune=generic -Wa,-mtune=generic32 -ffreestanding -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -pipe -Wno-sign-compare -fno-asynchronous-unwind-tables -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -Wframe-larger-than=1024 -fno-stack-protector -fno-omit-frame-pointer -fno-optimize-sibling-calls -g -pg -Wdeclaration-after-statement -Wno-pointer-sign -fwrapv -fno-dwarf2-cfi-asm  -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(hello5.mod)"  -D"KBUILD_MODNAME=KBUILD_STR(hello5)"  -DMODULE -c -o /media/Data_Movies/NageshA/help_desk/test/drivers/new-demo-examples/day1/1-hello/hello5.mod.o /media/Data_Movies/NageshA/help_desk/test/drivers/new-demo-examples/day1/1-hello/hello5.mod.c

deps_/media/Data_Movies/NageshA/help_desk/test/drivers/new-demo-examples/day1/1-hello/hello5.mod.o := \
  /media/Data_Movies/NageshA/help_desk/test/drivers/new-demo-examples/day1/1-hello/hello5.mod.c \
  ...
  /usr/src/linux-2.6.30/arch/x86/include/asm/pgtable-3level_types.h \
...
/media/Data_Movies/NageshA/help_desk/test/drivers/new-demo-examples/day1/1-hello/hello5.mod.o: $(deps_/media/Data_Movies/NageshA/help_desk/test/drivers/new-demo-examples/day1/1-hello/hello5.mod.o)
